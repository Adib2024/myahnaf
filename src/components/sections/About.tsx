          ...
          <div className="max-w-4xl">
            <Card className="bg-slate-900/40 border-slate-800 backdrop-blur-sm shadow-[0_4px_20px_rgba(0,0,0,0.1)] text-left">
              <CardContent className="p-8 md:p-12">
                ...
                <p className="text-lg text-gray-300 leading-relaxed mb-6">
                  Beyond traditional infrastructure, I bridge the gap between operations and development. By leveraging my scripting and programming skills in Python, Node.js, and Google Apps Script, I build automation tools and operational dashboards that streamline workflows, reduce manual toil, and enhance team efficiency.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 border-t border-slate-800 pt-10">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <div className="text-sm text-gray-400 font-medium uppercase tracking-wider">Tools & Scripts</div>
                  </div>
                </div>
              </CardContent>
            </Card>
