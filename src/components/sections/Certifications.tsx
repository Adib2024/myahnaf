        ...
        <ScrollReveal>
          ...
          <Card className="bg-slate-900/40 border-slate-800 backdrop-blur-sm shadow-[0_4px_20px_rgba(0,0,0,0.1)] text-left max-w-4xl mx-auto">
            <CardContent className="p-8 md:p-12">
              <h3 className="text-2xl font-bold mb-10 text-blue-500">Education</h3>
              <div className="space-y-10">
                <div className="relative pl-8 border-l-2 border-slate-800">
                  ...
                  <p className="text-gray-400 mt-2 text-lg">Universiti Malaysia Pahang & Hochschule Karlsruhe, Germany</p>
                ...
                <div className="relative pl-8 border-l-2 border-slate-800">
                  ...
                  <p className="text-gray-400 mt-2 text-lg">Kedah Matriculation College</p>
